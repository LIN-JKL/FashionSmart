...
const techFeatures = [
  {
    name: '深度学习模型',
    description: '基于YOLOv8深度学习框架，我们的模型经过了大量黄瓜病害图像的训练，能够准确识别各种复杂场景下的黄瓜病害。',
    icon: CpuChipIcon,
    details: [
      '采用YOLOv8n-cls模型架构',
      '训练50个epochs，图像尺寸224×224',
      '专门针对黄瓜病害进行优化',
      '高效的CPU推理能力'
    ]
  },
      ...
      <div className="container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            领先的
            <span className="text-gradient">技术介绍</span>
            驱动精准识别
          </h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            我们采用业界最前沿的人工智能技术，结合农业专业知识，打造出高精度、高效率的黄瓜病害识别系统
          </p>
        </motion.div>
