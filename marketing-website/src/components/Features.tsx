...
export default function Features() {
  ...
  const features = [
    {
      name: "图像识别",
      description: "采用深度学习技术，准确识别多种病害类型，识别准确率高达95%以上",
      icon: PhotoIcon,
    ...
    {
      name: "防治建议",
      description: "提供针对性的防治方案和用药建议，帮助农户科学防治病害",
      icon: ChartBarIcon,
      color: 'bg-purple-500',
    },
    {
    ...
    {
      name: "AI咨询",
      description: "智能AI农业顾问，随时解答黄瓜种植、病害防治等各类农业问题",
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            我们的黄瓜病害识别系统集成了多项先进技术，为农业生产提供全方位的智能解决方案
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-primary-600 to-accent-600 rounded-2xl p-8 md:p-12 text-white shadow-xl">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">立即体验先进识别技术</h3>
            <p className="text-lg mb-6 max-w-2xl mx-auto opacity-90">
              上传黄瓜图片，几秒钟内获得诊断结果，让病害识别变得简单高效
            </p>
